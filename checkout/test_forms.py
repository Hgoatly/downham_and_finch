...
class TestOrderForm(TestCase):
    ...
    def test_street_address2_is_not_required(self):
        form = OrderForm({'full_name': 'Test Full Name', 'email': 'Test Email',
                        'phone_number': 'Test Phone Number', 'street_address1': 'Test Street Address1'})
    ...
    def test_postcode_is_not_required(self):
        form = OrderForm({'full_name': 'Test Full Name', 'email': 'Test Email', 
                        'phone_number': 'Test Phone Number', 'street_address1': 'Test Street Address 1', 
                        'street_address2': 'Test Street Address 2', 'town_or_city': 'Test Town or City'})
        self.assertTrue(form.is_valid)
